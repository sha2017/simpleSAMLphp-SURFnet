...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML_Module::getModuleURL('sha2017/style.css'); ?>" />
  <link rel="stylesheet" media="screen and (max-width: 370px)" href="<?php echo SimpleSAML_Module::getModuleURL('sha2017/style_320.css'); ?>" />
	<link rel="stylesheet" media="screen and (max-device-width: 480px), handheld" href="<?php echo SimpleSAML_Module::getModuleURL('sha2017/style_480.css'); ?>" />
...
<body class="index" onload="initiate()">
	...
	<div id="wrapper">
		...
		<div id="header">
			<img id="logo" src="<?php echo SimpleSAML_Module::getModuleURL('sha2017/logo.png'); ?>" alt="" /> <!-- DIT IS HET LOGO -->
